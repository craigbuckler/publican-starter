...
export function contentFilename( filename, data ) {
...
export function contentSections( filename, data ) {
  data.content = data.content
...
export function renderstartTagScore() {
...
export function prerenderRelated( data ) {
...
export function postrenderMeta( data, output ) {
  return output
    .replace('</head>', '<meta name="generator" content="Publican.dev" />\n</head>');
}
